...
[//]: # ({x-version-update-start:proto-google-identity-accesscontextmanager-v1:released})

If you are using Gradle, add this to your dependencies
```Groovy
compile 'com.google.api.grpc:proto-google-identity-accesscontextmanager-v1:1.0.2'
```
If you are using SBT, add this to your dependencies
```Scala
libraryDependencies += "com.google.api.grpc" % "proto-google-identity-accesscontextmanager-v1" % "1.0.2"
```
