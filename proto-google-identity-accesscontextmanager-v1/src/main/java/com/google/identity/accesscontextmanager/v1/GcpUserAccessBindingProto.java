...
public final class GcpUserAccessBindingProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "Egoogle/identity/accesscontextmanager/v1/gcp_user_access_binding.proto\022\'google."
          + "identity.accesscontextmanager.v1\032\037google"
          + "/api/field_behavior.proto\032\031google/api/re"
          + "source.proto\032\034google/api/annotations.proto\"\243\002\n"
          ...
          + "access_levels\030\003 \003(\tB7\340A\002\372A1\n"
          + "/accesscontextmanager.googleapis.com/AccessLevel:\214\001\352A\210\001\n"
          + "8accesscontextmanager.googleapis.com/GcpUserAccessBinding\022Lorganizations/{organ"
          + "ization}/gcpUserAccessBindings/{gcp_user_access_binding}B\257\002\n"
          + "+com.google.identity.accesscontextmanager.v1B\031GcpUserAccessB"
          + "indingProtoP\001Z[google.golang.org/genproto/googleapis/identity/accesscontextmanag"
          ...
          + "Google::Identity::AccessContextManager::V1b\006proto3"
    };
    descriptor =
